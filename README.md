...
# Sobre:
Este é um fork de [bombcrypto-bot](https://github.com/mpcabete/bombcrypto-bot) que tem o seu código aberto, de forma que qualquer pessoa pode vê-lo, fazer uma fork, ou updates.
